...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/polyfills/number */ "./src/polyfills/number.ts");
...
var AbrController = /*#__PURE__*/function () {
  ...
  _proto.onFragLoaded = function onFragLoaded(event, _ref) {
    ...
    if (frag.type === _types_loader__WEBPACK_IMPORTED_MODULE_5__["PlaylistLevelType"].MAIN && Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(frag.sn)) {
      var stats = part ? part.stats : frag.stats;
    ...
    if (renditionReports) {
      for (var i = 0; i < renditionReports.length; i++) {
        ...
        if (uri === playlistUri.substr(-uri.length)) {
          ...
          if (Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(msn)) {
            return new _types_level__WEBPACK_IMPORTED_MODULE_1__["HlsUrlParameters"](msn, Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(part) ? part : undefined, _types_level__WEBPACK_IMPORTED_MODULE_1__["HlsSkip"].No);
          }
        }
      }
    }
...
var BaseStreamController = /*#__PURE__*/function (_TaskLoop) {
  ...
  _proto.onMediaSeeking = function onMediaSeeking() {
    ...
    this.log("media seeking to " + (Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(currentTime) ? currentTime.toFixed(3) : currentTime) + ", state: " + state);
  ...
  _proto._doFragLoad = function _doFragLoad(frag, details, targetBufferTime, progressCallback) {
    ...
    if (Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(frag.sn) && !this.bitrateTest) {
  ...
  _proto.getFwdBufferInfo = function getFwdBufferInfo(bufferable, type) {
    ...
    if (!Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(pos)) {
      return null;
    }
  ...
  */
  ...
  _proto.alignPlaylists = function alignPlaylists(details, previousDetails) {
    ...
    var aligned = details.alignedSliding && Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(slidingStart);
  ...
  _proto.setStartPosition = function setStartPosition(details, sliding) {
    ...
    if (startPosition === -1 || this.lastCurrentTime === -1) {
      ...
      if (Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(startTimeOffset)) {
...
var BufferController = /*#__PURE__*/function () {
  ...
  _proto.flushBackBuffer = function flushBackBuffer() {
    ...
    if (!Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(backBufferLength) || backBufferLength < 0) {
      return;
    }
  ...
  _proto.updateMediaElementDuration = function updateMediaElementDuration() {
    ...
    var msDuration = Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(mediaSource.duration) ? mediaSource.duration : 0;
    ...
    } else if (levelDuration > msDuration && levelDuration > mediaDuration || !Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(mediaDuration)) {
  ...
  _proto.removeExecutor = function removeExecutor(type, startOffset, endOffset) {
    ...
    var mediaDuration = Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(media.duration) ? media.duration : Infinity;
    var msDuration = Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(mediaSource.duration) ? mediaSource.duration : Infinity;
...
function findFragmentByPDT(fragments, PDTValue, maxFragLookUpTolerance) {
  if (PDTValue === null || !Array.isArray(fragments) || !fragments.length || !Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(PDTValue)) {
    return null;
  } // if less than start
...
function updateFromToPTS(fragFrom, fragTo) {
  ...
  if (Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(fragToPTS)) {
...
function updateFragPTSDTS(details, frag, startPTS, endPTS, startDTS, endDTS) {
  ...
  if (Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(fragStartPts)) {
    // delta PTS between audio and video
    var deltaPTS = Math.abs(fragStartPts - startPTS);

    if (!Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(frag.deltaPTS)) {
...
function mergeDetails(oldDetails, newDetails) {
  ...
  mapFragmentIntersection(oldDetails, newDetails, function (oldFrag, newFrag) {
    ...
    if (Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(oldFrag.startPTS) && Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(oldFrag.endPTS)) {
...
var StreamController = /*#__PURE__*/function (_BaseStreamController) {
  ...
  */
  ...
  _proto.onMediaSeeked = function onMediaSeeked() {
    ...
    if (Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(currentTime)) {
  ...
  _proto._handleTransmuxComplete = function _handleTransmuxComplete(transmuxResult) {
    ...
    if (initSegment) {
      ...
      if (Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(initPTS)) {
...
var initPTSFn = function initPTSFn(timestamp, timeOffset) {
  return Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(timestamp) ? timestamp * 90 : timeOffset * 90000;
};
      ...
      if (emsgs) {
        emsgs.forEach(function (data) {
          ...
          if (emsgSchemePattern.test(emsgInfo.schemeIdUri)) {
            var pts = Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(emsgInfo.presentationTime) ? emsgInfo.presentationTime / emsgInfo.timeScale : timeOffset + emsgInfo.presentationTimeDelta / emsgInfo.timeScale;
...
var TransmuxerInterface = /*#__PURE__*/function () {
  ...
  _proto.onWorkerMessage = function onWorkerMessage(ev) {
    ...
    switch (data.event) {
      ...
      case _events__WEBPACK_IMPORTED_MODULE_1__["Events"].KLV_RECEIVED:
        {
...
var TSDemuxer = /*#__PURE__*/function () {
      ...
      if (data[start] === 0x47) {
        ...
        if (privateDataPids.length > 0 && privateDataIndex > -1) {
          ...
          if (private_datas[privateDataIndex]) {
            ...
            private_datas[privateDataIndex].size += start + 188 - offset; // console.log("PTS PRIVATE EXPAND ")
          }
        } else {
          switch (pid) {
            //video 
            ...
            case pmtId:
              {
                ...
                privateDataPids = parsedPIDs.private_data; // console.log("PTS Private DATA PID " + JSON.stringify(privateDataPids))
  ...
  _proto.parsePESMpegTS = function parsePESMpegTS(pes_data) {
    var data = pes_data.data;
    var packet_start_code_prefix = data[0] << 16 | data[1] << 8 | data[2];
    var stream_id = data[3];
    var PES_packet_length = data[4] << 8 | data[5]; // Log.v(this.TAG,pes_data.stream_type);
  ...
  _proto.stripExtra0001 = function stripExtra0001(data) {
    var match = true;
    var target = new Uint8Array([0, 0, 0, 1, 0, 0, 0, 1]);
  ...
  _proto.checkPackageValidity = function checkPackageValidity(data) {
    var ptsdtsIndex = -1;
  ...
  _proto.parseAVCPES = function parseAVCPES(track, textTrack, pes, last) {
    ...
    var push;
    var spsfound = false;
    var data = this.stripExtra0001(pes.data);
    var invalid = this.checkPackageValidity(data); // free pes.data to save up some memory
...
function createLoaderContext(frag, part) {
  ...
  if (Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(start) && Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(end)) {
...
var Fragment = /*#__PURE__*/function (_BaseSegment) {
  ...
  _createClass(Fragment, [{
    ...
    get: function get() {
      ...
      if (!Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(this.programDateTime)) {
        return null;
      }

      var duration = !Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(this.duration) ? 0 : this.duration;
  ...
  _createClass(LevelDetails, [{
    ...
    get: function get() {
      if (this.fragments.length) {
        return Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(this.fragments[this.fragments.length - 1].programDateTime);
      }
  ...
  M3U8Parser.parseLevelPlaylist = function parseLevelPlaylist(string, baseurl, id, type, levelUrlId) {
    ...
    while ((result = LEVEL_PLAYLIST_REGEX_FAST.exec(string)) !== null) {
      ...
      if (duration) {
        ...
        // url
        if (Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(frag.duration)) {
          frag.start = totalduration;
          ...
          case 'SKIP':
            {
              ...
              if (Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(skippedSegments)) {
...
function assignProgramDateTime(frag, prevFrag) {
  ...
  if (!Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(frag.programDateTime)) {
...
var PlaylistLoader = /*#__PURE__*/function () {
  ...
  _proto.handleTrackOrLevelPlaylist = function handleTrackOrLevelPlaylist(response, stats, context, networkDetails) {
    ...
    var id = context.id,
        ...
        type = context.type;
    var url = getResponseUrl(response, context);
    var levelUrlId = Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(id) ? id : 0;
    var levelId = Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(level) ? level : levelUrlId;
...
var MP4Remuxer = /*#__PURE__*/function () {
  ...
  _proto.generateIS = function generateIS(audioTrack, videoTrack, timeOffset) {
    ...
    var tracks = {};
    var computePTSDTS = !Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(this._initPTS);
...
var PassThroughRemuxer = /*#__PURE__*/function () {
  ...
  _proto.remux = function remux(audioTrack, videoTrack, id3Track, textTrack, timeOffset) {
    ...
    if (!Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(lastEndDTS)) {
...
function alignDiscontinuities(lastFrag, details, lastLevel) {
  if (shouldAlignOnDiscontinuities(lastFrag, lastLevel, details)) {
    ...
    if (referenceFrag && Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(referenceFrag.start)) {
...
function alignPDT(details, lastDetails) {
  ...
  if (sliding && Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(sliding)) {
...
var FetchLoader = /*#__PURE__*/function () {
  ...
  _proto.load = function load(context, config, callbacks) {
    ...
    self.fetch(this.request).then(function (response) {
      ...
      if (onProgress && Object(_Users_v_Desktop_Work_Observer_myrepo_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__["isFiniteNumber"])(config.highWaterMark)) {
